  ...
  submit() {
    ...
    if (this.checkErrors()) {
      this.showDialog(
        ...
        'Hey ' +
          this.name +
          ', thanks for showing interest in our services 🥰. We will get back to you soon. Have a nice day!',
      );
    }
  }
...
@Component({
  ...
  template: `
    ...
    <div
      style="text-align: center; font-family: 'Poppins-Regular'; font-size: medium; color: white; font-weight: normal;
              padding-left: 20px; padding-right: 20px;"
    >
      {{ data.message }}
    </div>
